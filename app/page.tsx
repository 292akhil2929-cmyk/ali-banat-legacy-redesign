      ...
      <section className="hero" id="top">
        ...
        <div className="hero-collage" aria-label="Ali Banat and the humanitarian work of MATW Project">
          ...
          <figure className="hero-photo hero-photo-detail">
            ...
            <figcaption><span>His purpose</span><strong>People before possessions</strong></figcaption>
          </figure>
        </div>
